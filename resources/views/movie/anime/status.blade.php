    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="statusUpdateForm" action="{{ route('saveStatus') }}" method="POST">
                    {{ csrf_field() }}
...
<script>
    function editStatus(id) {
        $.get("{{ route('findStatus', '') }}"+id, function(status) {
            $("#id").val(status.id);
            $('#updateJudelAnime').html(status.judul_anime);
